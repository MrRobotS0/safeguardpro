...
public class AppDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Colaborador>(entity =>
        {
            ...
            entity.Property(e => e.Ctps).HasMaxLength(20).HasColumnName("ctps");
            ...
            entity.Property(e => e.NomeColab).HasMaxLength(100).HasColumnName("nome_colab");
        ...
        modelBuilder.Entity<Entrega>(entity =>
        {
            ...
            entity.HasOne(d => d.ColaboradorCodNavigation).WithMany(p => p.Entregas)
                ...
                .HasConstraintName("entrega_colaborador_cod_fkey");

            entity.HasOne(d => d.EpiCodNavigation).WithMany(p => p.Entregas)
                .HasForeignKey(d => d.EpiCod)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("entrega_epi_cod_fkey");
        });
        ...
        modelBuilder.Entity<Epi>(entity =>
        {
            ...
            entity.Property(e => e.EpiCod).HasColumnName("epi_cod");
            entity.Property(e => e.FormaAdequada).HasMaxLength(200).HasColumnName("forma_adequada");
