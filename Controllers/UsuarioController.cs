...
public class UsuarioController : ControllerBase
{
    ...
    {
        var colaboradorCod = _context.Colaboradors.FirstOrDefault(e => e.Email== model.Email && e.Cpf == model.Cpf);
        if (colaboradorCod != null)
        {
    ...
    [HttpGet("Check")]
    public async Task<ActionResult<String>> CheckUser(decimal Cpf, string Email)
    {
        var colaboradorCod = _context.Colaboradors.FirstOrDefault(e => e.Email== Email && e.Cpf == Cpf);
